...
def plot():
    number_of_plots = 3
    plotter = SerialPlotter('/dev/ttyUSB1', 9600, number_of_plots=number_of_plots, log_to_csv=False, plot_length=300)
    plotter.start()
    ...
    for i in range(number_of_plots):
        ...
        anim.append(animation.FuncAnimation(fig, plotter.get_serial_data, fargs=(lines, current_value_text,
